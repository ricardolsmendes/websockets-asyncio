...
class WebsocketRepliesManager:
    """Utility class with common features for handling replies over websocket communication
    sessions.
    ...
    def add_pending_ids(self, message_ids, method):
        for message_id in message_ids:
            self.add_pending_id(message_id, method)
